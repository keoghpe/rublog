...
class Rack::Directory::DirectoryBody < Anonymous_Struct_3
...
class Rack::Multipart::Parser::Collector::MimePart < Anonymous_Struct_4
  def get_data; end
end
...
class Rack::Session::Cookie::SessionId < Anonymous_Delegator_5
  def cookie_value; end
